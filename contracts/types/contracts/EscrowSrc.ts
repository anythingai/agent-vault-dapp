...
export interface EscrowSrcInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "RESOLVER_EXCLUSIVE_PERIOD",
    values?: undefined
  ): string;
...
export interface EscrowSrc extends BaseContract {
  ...
  RESOLVER_EXCLUSIVE_PERIOD: TypedContractMethod<[], [bigint], "view">;
  ...
  getFunction(
    nameOrSignature: "RESOLVER_EXCLUSIVE_PERIOD"
